...
if __name__=="__main__":
    ...
    print("orca_result",orca_results)
    aa = time.time()
    slot_result = fill_slot(intent=orca_intent,orca_result=orca_results,origin_sentence=test_sents)
    # print(slot_result["chains"]["chain0"]["set_dict"]["set_1"]["is_dict"]["国别"])
    # print(slot_result["chains"]["chain0"]["set_dict"]["set_1"]["not_dict"]["国别"])
    ...
    print(slot_result)
    print("target_chain:::",slot_result["chains"][target_chain_]["rank"])
    print("target_terms:::",terms)
    print(slot_result["chains"][target_chain_])
    print("target_intent:::",slot_result["chains"][target_chain_]["chain_name"])
